...
<div id="wrapper">
  <div class="breadcrumbs cle"> <?php echo $this->fetch('library/ur_here_goods.lbi'); ?> 
...
?> 
                ...
                <a href="snatch.php" title="<?php echo $this->_var['lang']['snatch']; ?>" style="font-weight:100; color:#1e9246; text-decoration:none;">[<?php echo $this->_var['lang']['snatch']; ?>]</a> 
                <?php elseif ($this->_var['item']['type'] == "group_buy"): ?> 
                <a href="group_buy.php" title="<?php echo $this->_var['lang']['group_buy']; ?>" style="font-weight:100; color:#1e9246; text-decoration:none;">[<?php echo $this->_var['lang']['group_buy']; ?>]</a> 
                <?php elseif ($this->_var['item']['type'] == "auction"): ?> 
                <a href="auction.php" title="<?php echo $this->_var['lang']['auction']; ?>" style="font-weight:100; color:#1e9246; text-decoration:none;">[<?php echo $this->_var['lang']['auction']; ?>]</a> 
                <?php elseif ($this->_var['item']['type'] == "favourable"): ?> 
                <a href="activity.php" title="<?php echo $this->_var['lang']['favourable']; ?>" style="font-weight:100; color:#1e9246; text-decoration:none;">[<?php echo $this->_var['lang']['favourable']; ?>]</a> 
                <?php endif; ?> 
                <a href="<?php echo $this->_var['item']['url']; ?>" title="<?php echo $this->_var['lang'][$this->_var['item']['type']]; ?> <?php echo $this->_var['item']['act_name']; ?><?php echo $this->_var['item']['time']; ?>" style="font-weight:100; color:#1e9246;"><?php echo $this->_var['item']['act_name']; ?></a><br />
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
              </li>
              <?php endif; ?>
              
              <li><span class="lbl">销&nbsp;&nbsp;&nbsp;量</span><span>最近售出<em class="red"><?php echo $this->_var['sales_count']; ?></em>件</span>（<a href="#pjxqitem" id="pjxqitem_trig">已有 <?php echo $this->_var['goods']['comments_number']; ?> 人评价</a>）</li>
            </ul>
          </dd>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="btn" id="buy_btn"><i class="iconfont">ŭ</i>加入购物车</a> <a id="fav-btn" class="graybtn" href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)"><i class="iconfont">Ū</i>收藏</a></li>
	    </ul>
          </dd>
        </dl>
      </div>
...
?>
	  ...
	  <div class="z-detail-right">
	  	...
	  	<div class="hot_box">
			<ul>
				<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_20594000_1484063772');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_20594000_1484063772']):
?>
				<li>
					<a href="<?php echo $this->_var['goods_0_20594000_1484063772']['url']; ?>" target="_self">
						<img width="194px" height="194px" src="<?php echo $this->_var['goods_0_20594000_1484063772']['thumb']; ?>" />
						<p><?php echo $this->_var['goods_0_20594000_1484063772']['short_style_name']; ?></p>
						<p class="hot_price">
							<?php if ($this->_var['goods_0_20594000_1484063772']['promote_price'] != ""): ?>
          					<?php echo $this->_var['goods_0_20594000_1484063772']['promote_price']; ?>
          					<?php else: ?>
          					<?php echo $this->_var['goods_0_20594000_1484063772']['shop_price']; ?>
          					<?php endif; ?>
						</p>
					</a>
				</li>
