...
//      console.log("newtop",newtop)
 ...
 <script type="text/javascript" src="js/lizi_category.js"></script><div id="wrapper"> 
  ...
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">酒水饮料</a> <code>&gt;</code> <a href="category.php?id=24">葡萄酒</a></div>  <div class="main cle"> 
    
    <div class="sidebar">
      <div class="cate-menu" id="cate-menu">
        <h3><a href="category.php?id=24"><strong>葡萄酒</strong><i id="total_count">商品共3件</i></a></h3>
        <dl>
    ...
    <div class="bd" style="border-top:0;">
        ...
        <dl class="brand">
            <dd>
            	                 <a href="category.php?id=24&amp;brand=9" target="_blank" rel="nofollow">金赏</a>
                                  <a href="category.php?id=24&amp;brand=7" target="_blank" rel="nofollow">比瑞吉</a>
                                  <a href="category.php?id=24&amp;brand=1" target="_blank" rel="nofollow">艾尔Aier</a>
      ...
      <div class="search-options" id="search-options">
        <div class="bd">
            ...
            <dd style="height: 48px;">
              <div class="items cle"> 
                                                                                <div class="link"> <a href="category.php?id=24&amp;brand=1&amp;price_min=0&amp;price_max=0" class="item">艾尔Aier</a> </div>
                                                                <div class="link"> <a href="category.php?id=24&amp;brand=7&amp;price_min=0&amp;price_max=0" class="item">比瑞吉</a> </div>
                                                                <div class="link"> <a href="category.php?id=24&amp;brand=9&amp;price_min=0&amp;price_max=0" class="item">金赏</a> </div>
  ...
  <div class="bd">
    <form method="GET" name="listform">
      <a title="销量" href="category.php?category=24&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list" class="curr" rel="nofollow"><span class="search_DESC">销量</span></a> <a title="价格" href="category.php?category=24&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"  rel="nofollow"><span class="">价格</span></a> <a title="上架时间" href="category.php?category=24&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list" rel="nofollow"><span class="">上架时间</span></a>
  ...
  <div class="search_num">共<b>3</b>个商品 <span id="search_btn" class="search_btn"><a href="javascript:void(0);" class="iconfont"></a> <span> 
