...
<title>Johnnie Walker尊尼获加黑牌威士忌_饮料/水_酒水饮料_渔湾仔 官方商城</title>
  ...
  <div class="hd_nav">
    <div class="hd_nav_bd cle">
      <div class="main_nav" id="main_nav">
        <div class="main_nav_link"> <span class="icon-th-list"></span><a href="javascript:;">全部商品分类</a> <i class="iconfont"></i> </div>
...
<div id="wrapper">
  <div class="breadcrumbs cle"> <div class="menus">您当前的位置：<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">酒水饮料</a> <code>&gt;</code> <a href="category.php?id=28">饮料/水</a> <code>&gt;</code> Johnnie Walker尊尼获加黑牌威士忌</div> 
     
  </div>
  <div class="detail cle"> 
     
    <div class="detail_img" id="detail_img">
  <div class="pic_view"> <a href="images/201512/goods_img/50_P_1448946543091.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;" onclick="window.open('gallery.php?id=50'); return false;"> <img  alt="Johnnie Walker尊尼获加黑牌威士忌" src="images/201512/goods_img/50_P_1448946543091.jpg"> </a> </div>
  ...
  <div class="bd">
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201512/goods_img/50_P_1448946543091.jpg" rel="zoom-id: Zoomer" rev="images/201512/goods_img/50_P_1448946543091.jpg"> <img alt="Johnnie Walker尊尼获加黑牌威士忌" src="images/201512/thumb_img/50_thumb_P_1448946543313.jpg"> </a></li>
            <li > <a href="images/201512/goods_img/50_P_1448946542182.jpg" rel="zoom-id: Zoomer" rev="images/201512/goods_img/50_P_1448946542182.jpg"> <img alt="Johnnie Walker尊尼获加黑牌威士忌" src="images/201512/thumb_img/50_thumb_P_1448946542880.jpg"> </a></li>
...
</div>    <form action="javascript:addToCart(50)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
        ...
        <dl class="loaded">
          ...
          <dd class="property">
            <ul>
                            ...
                            <li> <span class="lbl">市场价</span> <em class="cancel">￥24元</em> </li>
                            <li> 
                 
		<script type="text/javascript" src="themes/lizi/js/lefttime.js"></script>
                <span class="icon_promo">抢购</span> <span class="lbl">促销价</span> <span class="unit"> <strong class="nala_price red" id="ECS_SHOPPRICE">￥19元</strong> </span>  <span class="timedown" id="timedown"><i class="iconfont">:</i>剩余时间：<strong id="leftTime" class="font_w">请稍等, 正在载入中...</strong></span> 
                ...
                <a href="group_buy.php?act=view&amp;id=7" title="团购活动 贝贝宠物零食A级鸡肉整枝800g鸡胸肉干的时间为2015-11-25到2021-11-29，赶快来抢吧！" style="font-weight:100; color:#1e9246;">贝贝宠物零食A级鸡肉整枝800g鸡胸肉干</a><br />
              ...
              <li><span class="lbl">销&nbsp;&nbsp;&nbsp;量</span><span>最近售出<em class="red">321</em>件</span>（<a href="#pjxqitem" id="pjxqitem_trig">已有 0 人评价</a>）</li>
            </ul>
          </dd>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart(50)" class="btn" id="buy_btn"><i class="iconfont">ŭ</i>加入购物车</a> <a id="fav-btn" class="graybtn" href="javascript:collect(50)"><i class="iconfont">Ū</i>收藏</a></li>
	    </ul>
          </dd>
        </dl>
      </div>
        ...
        <div class="tabs_bar_warp">
          <div class="tabs_bar" id="tabs_bar">
            <ul>
              ...
              <li class="tab-buy" id="tab-buy"><strong id="ECS_SHOPPRICE_TOP">￥19元</strong><a class="btn" href="javascript:addToCart(50);">购 买</a> </li>
            </ul>
          </div>
        </div>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td width="80%"> Johnnie Walker尊尼获加黑牌威士忌</td>
                      </tr>
...
<img width="790" height="602" src="/images/upload/Image/3.jpg" alt="" /></p></div>
          ...
          <div class="z-box sectionbox">
              	...
              	<script type="text/javascript" src="js/transport_jquery.js"></script><script type="text/javascript" src="js/utils.js"></script><div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:50;}554fcae493e564ee0dc75bdf2ebf94ca</div>    
          </div>
        </div>
      </div>
      ...
      <div class="quickBoxInner clearfix">
        ...
        <div class="quickBox clearfix">
          <form action="quick_buy.php" method="post" name="ECS_FORMQUICKBUY" id="ECS_FORMQUICKBUY" onsubmit="return checkOrderForm(this)">
            <input name="goods_id" type="hidden" value="50"/>
            <input name="goods_sn" type="hidden" value="ECS000050"/>
            <input name="goods_weight" type="hidden" value="0克"/>
            <input name="market_price" type="hidden" value="￥24元"/>
            <ul class="QuickProductBox clearfix">
              <li><em>商品名称：</em>
                <input name="goods_name" type="text" class="textInput" value="Johnnie Walker尊尼获加黑牌威士忌" readonly style="width:300px" />
              </li>
            ...
            <ul class="quickAddressBox clearfix">
              ...
              <li class="w150"><em>购物数量：</em><input name="qty" type="text" value="1" class="textInput" id="textNum"  onblur="quick_to_cart(50)"/></li>
              ...
              <li id="payment_list">
			  	<em>支付方式：</em>
				<div class="sku_box2">
								<label class="selected sku_list2" for="pay_quick_value_1"><input type="radio" name="payment" id="pay_quick_value_1" value="1"  checked isCod="0"  onClick="quick_to_cart(50);" style="display:none;"/>支付宝<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_2"><input type="radio" name="payment" id="pay_quick_value_2" value="2"  isCod="0"  onClick="quick_to_cart(50);" style="display:none;"/>余额支付<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_3"><input type="radio" name="payment" id="pay_quick_value_3" value="3"  isCod="0"  onClick="quick_to_cart(50);" style="display:none;"/>银行汇款/转帐<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_4"><input type="radio" name="payment" id="pay_quick_value_4" value="4"  isCod="1"  onClick="quick_to_cart(50);" style="display:none;"/>货到付款<span class="icon_bg">已选中</span></label>
								</div>
			  </li>
            </ul>
