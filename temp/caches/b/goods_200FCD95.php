...
<div id="wrapper">
  <div class="breadcrumbs cle"> <div class="menus">您当前的位置：<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">酒水饮料</a> <code>&gt;</code> <a href="category.php?id=29">红酒</a> <code>&gt;</code> 52度茅台集团国隆双喜酒500mlx6</div>
  ...
  <div class="pic_view"> <a href="images/201512/goods_img/16_P_1448947194687.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;" onclick="window.open('gallery.php?id=16'); return false;"> <img  alt="52度茅台集团国隆双喜酒500mlx6" src="images/201512/goods_img/16_P_1448947194687.jpg"> </a> </div>
  ...
  <div class="bd">
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201512/goods_img/16_P_1448947194687.jpg" rel="zoom-id: Zoomer" rev="images/201512/goods_img/16_P_1448947194687.jpg"> <img alt="52度茅台集团国隆双喜酒500mlx6" src="images/201512/thumb_img/16_thumb_P_1448947194737.jpg"> </a></li>
      ...
      <div class="item-info" id="item-info">
        <dl class="loaded">
          ...
          <dt class="product_name">
            <h1>52度茅台集团国隆双喜酒500mlx6</h1>
            <p class="desc"> <span class="gray">贵州茅台酒厂（集团）保健酒业有限公司生产，是以“龙”字打头的酒水。中国龙文化上下8000年，源远而流长，龙的形象是一种符号、一种意绪、一种血肉相联的情感。</span> </p>
          </dt>
          ...
          <dd class="property">
            <ul>
                            ...
                            <li> <span class="lbl">市场价</span> <em class="cancel">￥23元</em> </li>
                            <li> 
                 
                <span class="lbl">本店价</span> <span class="unit"> <strong class="nala_price red" id="ECS_SHOPPRICE">￥19元</strong> </span>  
              ...
              <li><span class="lbl">销&nbsp;&nbsp;&nbsp;量</span><span>最近售出<em class="red">877</em>件</span>（<a href="#pjxqitem" id="pjxqitem_trig">已有 0 人评价</a>）</li>
            </ul>
          </dd>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart(16)" class="btn" id="buy_btn"><i class="iconfont">ŭ</i>加入购物车</a> <a id="fav-btn" class="graybtn" href="javascript:collect(16)"><i class="iconfont">Ū</i>收藏</a></li>
	    </ul>
          </dd>
        </dl>
      </div>
        ...
        <div class="tabs_bar_warp">
          <div class="tabs_bar" id="tabs_bar">
            <ul>
              ...
              <li class="tab-buy" id="tab-buy"><strong id="ECS_SHOPPRICE_TOP">19.00</strong><a class="btn" href="javascript:addToCart(16);">购 买</a> </li>
            </ul>
          </div>
        </div>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td width="80%"> 52度茅台集团国隆双喜酒500mlx6</td>
                      </tr>
...
<img width="790" height="602" src="/images/upload/Image/3.jpg" alt="" /></p></div>
          ...
          <div class="z-box sectionbox">
              	...
              	<script type="text/javascript" src="js/transport_jquery.js"></script><script type="text/javascript" src="js/utils.js"></script><div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:16;}554fcae493e564ee0dc75bdf2ebf94ca</div>
      ...
      <div class="quickBoxInner clearfix">
        ...
        <div class="quickBox clearfix">
          <form action="quick_buy.php" method="post" name="ECS_FORMQUICKBUY" id="ECS_FORMQUICKBUY" onsubmit="return checkOrderForm(this)">
            <input name="goods_id" type="hidden" value="16"/>
            <input name="goods_sn" type="hidden" value="ECS000016"/>
            <input name="goods_weight" type="hidden" value="0克"/>
            <input name="market_price" type="hidden" value="￥23元"/>
            <ul class="QuickProductBox clearfix">
              <li><em>商品名称：</em>
                <input name="goods_name" type="text" class="textInput" value="52度茅台集团国隆双喜酒500mlx6" readonly style="width:300px" />
              </li>
            ...
            <ul class="quickAddressBox clearfix">
              ...
              <li class="w150"><em>购物数量：</em><input name="qty" type="text" value="1" class="textInput" id="textNum"  onblur="quick_to_cart(16)"/></li>
              ...
              <li id="payment_list">
			  	<em>支付方式：</em>
				<div class="sku_box2">
								<label class="selected sku_list2" for="pay_quick_value_1"><input type="radio" name="payment" id="pay_quick_value_1" value="1"  checked isCod="0"  onClick="quick_to_cart(16);" style="display:none;"/>支付宝<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_2"><input type="radio" name="payment" id="pay_quick_value_2" value="2"  isCod="0"  onClick="quick_to_cart(16);" style="display:none;"/>余额支付<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_3"><input type="radio" name="payment" id="pay_quick_value_3" value="3"  isCod="0"  onClick="quick_to_cart(16);" style="display:none;"/>银行汇款/转帐<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_4"><input type="radio" name="payment" id="pay_quick_value_4" value="4"  isCod="1"  onClick="quick_to_cart(16);" style="display:none;"/>货到付款<span class="icon_bg">已选中</span></label>
								</div>
			  </li>
            </ul>
