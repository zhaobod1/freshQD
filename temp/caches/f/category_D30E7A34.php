...
//      console.log("newtop",newtop)
 ...
 <script type="text/javascript" src="js/lizi_category.js"></script><div id="wrapper"> 
  ...
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">酒水饮料</a> <code>&gt;</code> 森美</div>
  <div class="main cle"> 
    
    <div class="sidebar">
      <div class="cate-menu" id="cate-menu">
        <h3><a href="category.php?id=1"><strong>酒水饮料</strong><i id="total_count">商品共1件</i></a></h3>
        <dl>
    ...
    <div class="maincon"> 
        ...
        <a href="category.php?id=1&amp;price_min=0&amp;price_max=0" class="item">森美</a> 
  ...
  <div class="bd">
    <form method="GET" name="listform">
      <a title="销量" href="category.php?category=1&display=grid&brand=5&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list" class="curr" rel="nofollow"><span class="search_DESC">销量</span></a> <a title="价格" href="category.php?category=1&display=grid&brand=5&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"  rel="nofollow"><span class="">价格</span></a> <a title="上架时间" href="category.php?category=1&display=grid&brand=5&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list" rel="nofollow"><span class="">上架时间</span></a>
...
<div class="productlist">
  <ul class="cle">
        ...
        <li> <a href="goods.php?id=22" target="_blank" class="productitem"> <span class="productimg"> <img width="150" height="150" title="芝华士12年 苏格兰威士忌700ml" alt="芝华士12年 苏格兰威士忌700ml" src="images/201512/thumb_img/22_thumb_G_1448946729918.jpg" style="display: block;"> </span> <span class="nalaprice xszk"><b> 
      ￥59元 
      
      </b> </span> <span class="productname">芝华士12年 苏格兰威士忌700ml</span> <span class="description"></span> <span class="price"> 专柜价：￥71元 </span> <span class="salerow"> 销量：<span class="sales">47</span>件 </span> </a> <a href="javascript:addToCart(22)" class="addcart" target="_blank" rel="nofollow">加入购物车</a> </li>
