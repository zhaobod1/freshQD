...
<div id="wrapper">
  <div class="breadcrumbs cle"> <div class="menus">您当前的位置：<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">生鲜食品</a> <code>&gt;</code> <a href="category.php?id=16">海鲜水产</a> <code>&gt;</code> 田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛</div>
  ...
  <div class="pic_view"> <a href="images/201512/goods_img/2_P_1448945810202.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;" onclick="window.open('gallery.php?id=2'); return false;"> <img  alt="田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛" src="images/201512/goods_img/2_P_1448945810202.jpg"> </a> </div>
  ...
  <div class="bd">
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201512/goods_img/2_P_1448945810202.jpg" rel="zoom-id: Zoomer" rev="images/201512/goods_img/2_P_1448945810202.jpg"> <img alt="田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛" src="images/201512/thumb_img/2_thumb_P_1448945810984.jpg"> </a></li>
            <li > <a href="images/201512/goods_img/2_P_1448945810814.jpg" rel="zoom-id: Zoomer" rev="images/201512/goods_img/2_P_1448945810814.jpg"> <img alt="田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛" src="images/201512/thumb_img/2_thumb_P_1448945810585.jpg"> </a></li>
      ...
      <div class="item-info" id="item-info">
        <dl class="loaded">
          ...
          <dt class="product_name">
            ...
            <p class="desc"> <span class="gray">前腿+后腿+羊排共8斤，原生态大山放牧羊羔，曾经的皇室贡品，央视推荐，2005年北京招待全球财金首脑。五层专用包装箱+真空包装+冰袋+保鲜箱+顺丰冷链发货，路途保质期8天</span> </p>
          </dt>
          ...
          <dd class="property">
            <ul>
                            ...
                            <li> <span class="lbl">市场价</span> <em class="cancel">￥106元</em> </li>
                            <li> 
                 
                <span class="lbl">本店价</span> <span class="unit"> <strong class="nala_price red" id="ECS_SHOPPRICE">￥88元</strong> </span>  
              ...
              <li><span class="lbl">销&nbsp;&nbsp;&nbsp;量</span><span>最近售出<em class="red">743</em>件</span>（<a href="#pjxqitem" id="pjxqitem_trig">已有 0 人评价</a>）</li>
            </ul>
          </dd>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart(2)" class="btn" id="buy_btn"><i class="iconfont">ŭ</i>加入购物车</a> <a id="fav-btn" class="graybtn" href="javascript:collect(2)"><i class="iconfont">Ū</i>收藏</a></li>
	    </ul>
          </dd>
        </dl>
      </div>
  ...
  <div class="taocan_bd">
    ...
    <div class="taocan_panels" id="taocan_panels"> 
        ...
        <form name="m_goods_0" method="post" action="" onSubmit="return false;">
          <h4></h4>
          <ul class="cle">
            <div style="float:left;"><li><a target="_blank" class="pic" href=""> <img alt="田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛" src="images/201512/thumb_img/2_thumb_G_1448945810147.jpg"></a>
              <p class="name"> <a target="_blank" href="">田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛</a> </p>
              <p class="price">
                <input type="checkbox" value="2" data="88.00 " spare="0" stock="0" class="m_goods_body m_goods_0" item="m_goods_0">
                ￥88元</p>
            	</li>
            </div>
            <div id="fittingBox" class="fittingitem">
              <ul> 
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=4"> <img alt="乌拉圭进口牛肉卷 特级肥牛卷" src="images/201512/thumb_img/4_thumb_G_1448945381841.jpg"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=4">乌拉圭进口牛肉卷 特级肥牛卷</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="4" data="75" spare="0" stock="0">
                    ￥75</p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=5"> <img alt="澳洲进口安格斯牛切片上脑牛排1000g" src="images/201512/thumb_img/5_thumb_G_1448945270486.jpg"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=5">澳洲进口安格斯牛切片上脑牛排1000g</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="5" data="120" spare="0" stock="0">
                    ￥120</p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=6"> <img alt="潮香村澳洲进口牛排家庭团购套餐20片" src="images/201512/thumb_img/6_thumb_G_1448945167914.jpg"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=6">潮香村澳洲进口牛排家庭团购套餐20片</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="6" data="199" spare="0" stock="0">
                    ￥199</p>
                </li>
            ...
            <li class="price_info submit_0">
              ...
              <p class="buy"><a href="javascript:addMultiToCart('m_goods_0', '2')" class="btn">购买套餐</a></p>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 2); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 2); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),2); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),2); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
        ...
        <div class="tabs_bar_warp">
          <div class="tabs_bar" id="tabs_bar">
            <ul>
              ...
              <li class="tab-buy" id="tab-buy"><strong id="ECS_SHOPPRICE_TOP">88.00</strong><a class="btn" href="javascript:addToCart(2);">购 买</a> </li>
            </ul>
          </div>
        </div>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td width="80%"> 田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛</td>
                      </tr>
...
<img width="790" height="602" src="/images/upload/Image/3.jpg" alt="" /></p></div>
          ...
          <div class="z-box sectionbox">
              	...
              	<script type="text/javascript" src="js/transport_jquery.js"></script><script type="text/javascript" src="js/utils.js"></script><div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:2;}554fcae493e564ee0dc75bdf2ebf94ca</div>
      ...
      <div class="quickBoxInner clearfix">
        ...
        <div class="quickBox clearfix">
          <form action="quick_buy.php" method="post" name="ECS_FORMQUICKBUY" id="ECS_FORMQUICKBUY" onsubmit="return checkOrderForm(this)">
            ...
            <input name="goods_sn" type="hidden" value="ECS000002"/>
            <input name="goods_weight" type="hidden" value="0克"/>
            <input name="market_price" type="hidden" value="￥106元"/>
            <ul class="QuickProductBox clearfix">
              <li><em>商品名称：</em>
                <input name="goods_name" type="text" class="textInput" value="田然牛肉大黄瓜条生鲜牛肉冷冻真空黄牛" readonly style="width:300px" />
              </li>
            ...
            <ul class="quickAddressBox clearfix">
              ...
              <li class="w150"><em>购物数量：</em><input name="qty" type="text" value="1" class="textInput" id="textNum"  onblur="quick_to_cart(2)"/></li>
              ...
              <li id="payment_list">
			  	<em>支付方式：</em>
				<div class="sku_box2">
								<label class="selected sku_list2" for="pay_quick_value_1"><input type="radio" name="payment" id="pay_quick_value_1" value="1"  checked isCod="0"  onClick="quick_to_cart(2);" style="display:none;"/>支付宝<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_2"><input type="radio" name="payment" id="pay_quick_value_2" value="2"  isCod="0"  onClick="quick_to_cart(2);" style="display:none;"/>余额支付<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_3"><input type="radio" name="payment" id="pay_quick_value_3" value="3"  isCod="0"  onClick="quick_to_cart(2);" style="display:none;"/>银行汇款/转帐<span class="icon_bg">已选中</span></label>
								<label class=" sku_list2" for="pay_quick_value_4"><input type="radio" name="payment" id="pay_quick_value_4" value="4"  isCod="1"  onClick="quick_to_cart(2);" style="display:none;"/>货到付款<span class="icon_bg">已选中</span></label>
								</div>
			  </li>
            </ul>
