...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1">
        <tr>
          <td align="left" bgcolor=""><a href="user.php?act=account_deposit" class="f6">充值</a> | <a href="distribute.php?act=account_detail" class="f6">账户明细</a> | <a href="distribute.php?act=account_log" class="f6">提现记录</a></td>
        </tr>
      </table>
      <?php endif; ?> 
      ...
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
            ...
            <dl>
              ...
              <input name="real_name" type="text" placeholder="输入真实姓名" value="如：模板之家" class="dd2">
            </dl>
             <dl>
              <dd class="dd1">开户行 </dd>
