...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/ocailong_com/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
  ...
  <form action="user.php" method="post" name="formBooking" onsubmit="return addBooking();">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      <tr>
        <td width="70">订购商品</td>
        <td><input type="text" value="<?php echo $this->_var['info']['goods_name']; ?>" class="inputBg" style="width:99%;padding:0 0.5%;" disabled="true" /></td>
      </tr>
      <tr>
        <td>订购数量</td>
        <td><input name="number" type="text" value="<?php echo $this->_var['info']['goods_number']; ?>" class="inputBg" style="width:99%;padding:0 0.5%;" /></td>
      </tr>
      <tr>
        <td>订购描述</td>
        <td><textarea name="desc" rows="5" wrap="virtual" style="width:99%;padding:0.5%;"><?php echo $this->_var['goods_attr']; ?><?php echo htmlspecialchars($this->_var['info']['goods_desc']); ?></textarea></td>
      </tr>
      <tr>
        <td>联系人</td>
        <td><input name="linkman" type="text" value="<?php echo htmlspecialchars($this->_var['info']['consignee']); ?>" size="25"  class="inputBg" style="width:99%;padding:0 0.5%;" /></td>
      </tr>
      <tr>
        <td>电子邮件</td>
        <td><input name="email" type="text" value="<?php echo htmlspecialchars($this->_var['info']['email']); ?>" size="25" class="inputBg" style="width:99%;padding:0 0.5%;" /></td>
      </tr>
      <tr>
        <td>联系电话</td>
        <td><input name="tel" type="text" value="<?php echo htmlspecialchars($this->_var['info']['tel']); ?>" size="25" class="inputBg" style="width:99%;padding:0 0.5%;" /></td>
      </tr>
      <tr>
        <td colspan="2"><input name="act" type="hidden" value="act_add_booking" />
          ...
          <input type="submit" name="submit" class="c-btn3" value="<?php echo $this->_var['lang']['submit_booking_goods']; ?>" />        </td>
        </tr>
    </table>
  </form>
      </section>
