...
*火一五信息科技（www.huo15.com)分销微分销分销中心
...
if ($action == 'default')
{
	...
	/*火一五信息科技（www.huo15.com)分销微分销新增显示分销会员标准*/
	$affiliate = unserialize($GLOBALS['_CFG']['affiliate']);
	...
	/*火一五信息科技（www.huo15.com)分销微分销新增查询佣金*/
	//推荐注册分成
	$affiliate = unserialize($GLOBALS['_CFG']['affiliate']);
	$user_list['user_list'] = array();
	$auid = $_SESSION['user_id'];
    ...
    for ($i = 1; $i<=$num; $i++)
    {
        ...
        if ($count)
        {
			...
			foreach($user_info as $key=>$value){
				/*火一五信息科技（www.huo15.com)分销微分销开发未付款的佣金统计*/
				...
				/*火一五信息科技（www.huo15.com)分销微分销开发已经付款且未收货佣金统计*/
				...
				/*火一五信息科技（www.huo15.com)分销微分销开发已经收货佣金统计*/
...

{
	...
	/*火一五信息科技（www.huo15.com)分销微分销优化提现流程*/
...

    {
        ...
        $pay_obj = new $payment_info['pay_code'];
				...
				//开始火一五信息科技（www.huo15.com)分销开发，兼容微信支付
...

{
	...
	//火一五信息科技（www.huo15.com)分销显示会员等级和下面人数
...
//火一五信息科技（www.huo15.com)分销微分销开发结束
